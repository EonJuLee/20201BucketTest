...
public class SharePage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso=new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .requestEmail()
                .build();
        mGoogleSingInClient= GoogleSignIn.getClient(SharePage.this,gso);
        ...
        find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SharePage.this,FindpwActivity.class);
    ...
    private void login(final String email,final String pw){
        mAuth.signInWithEmailAndPassword(email, pw)
                .addOnCompleteListener(SharePage.this, new OnCompleteListener<AuthResult>() {
                    @Override
    ...
    public void showToast(String contents){
        Toast.makeText(SharePage.this,contents,Toast.LENGTH_SHORT).show();
    }

    public void signupUI(){
        Intent intent = new Intent(SharePage.this,SignupActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    public void updateUI(FirebaseUser user){
        if(user!=null) {
            Intent intent = new Intent(SharePage.this, SharelistPage.class);
            startActivity(intent);
            finish();
        }
    }
    ...
    public void updateUIwithName(FirebaseUser user){
        ...
        Intent intent =new Intent(SharePage.this,InitialActivity.class);
